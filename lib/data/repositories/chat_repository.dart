...
class ChatRepository extends BaseRepository {
  ...
  Future<void> markMessagesAsRead(String chatRoomId, String userId) async {
    try {
      ...
      final unreadMessages = await getChatRoomMessages(chatRoomId)
          ...
          .where('status', isEqualTo: MessageStatus.sent.toString())
          .get();
      printToConsole("found ${unreadMessages.docs.length} unread messages");
      ...
      for (final doc in unreadMessages.docs) {
        ...
        printToConsole("Marked messaegs as read for user $userId");
      }
    } catch (e) {
  ...
  Future<void> updateTypingStatus(
    ...
    try {
      ...
      if (!doc.exists) {
        printToConsole("chat room does not exist");
        return;
      }
      ...
      printToConsole("error updating typing status");
    }
  }
